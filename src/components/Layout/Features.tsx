    ...
    <main className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7 relative">
          <BentoTilt className="bento_tilt_1 row-span-2 md:col-span-1 md:row-span-2">
            <BentoCard
          ...
          {/* second part of grid */}
          <BentoTilt className="bento_tilt_1 row-span-1 md:col-span-1 md:ms-0">
            <BentoCard
          ...
          <BentoTilt className="bento_tilt_1 row-span-1 md:col-span-1">
            <BentoCard
